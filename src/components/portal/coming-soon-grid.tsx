  ...
  const items = [
    {
      ...
      icon: (
        <svg aria-hidden="true" className="size-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((item) => (
          ...
          >
            ...
            <span className="absolute right-3 top-3 rounded-full bg-slate-200 px-2 py-0.5 text-xs font-semibold uppercase tracking-wider text-slate-500">
              Proximamente
            </span>
          </div>
        ))}
