// Contenido editorial estatico para la landing de la Tecnicatura Superior en Desarrollo de Software
...
export const careerHero = {
  ...
  ctaPrimary: 'Ver plan de estudios',
  ctaSecondary: 'Descargar información',
}

export const careerIntro = {
  title: 'Formación técnica superior con proyección profesional',
  description:
...
export const careerProfile = {
  ...
  subtitle: 'Un técnico formado para construir el futuro digital',
  blocks: [
    {
  ...
  quote: '"El software no solo cambia sistemas, cambia la forma en que el mundo avanza."',
}

export const careerStudyPlan = {
  title: 'Plan de Estudios',
  subtitle: 'Curricula académica',
  description:
  ...
  durationLabel: '3 años de formación',
  structureLabel: 'Estructura por cuatrimestres',
  focusLabel: 'Enfoque progresivo del aprendizaje',
}

export const careerPdfs = [
  {
    id: 'pdf-general',
