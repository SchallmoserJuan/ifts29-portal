...
export const defaultNews: NewsItem[] = [
  ...
  },
  {
    ...
    summary:
      'Firmamos acuerdos con empresas locales para prácticas profesionalizantes de nuestros estudiantes.',
    category: 'institutional',
...
export const defaultProjects: ProjectItem[] = [
  {
    ...
    image: {
      ...
      alt: 'LibroVault — Sistema de gestión bibliotecaria',
    },
    student: {
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'DataViz CABA — Dashboard de datos públicos',
    },
    student: {
      id: 'default-student-2',
      firstName: 'Lucas',
      lastName: 'Martínez',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'TrackBus — Seguimiento de transporte público',
    },
    student: {
      id: 'default-student-3',
      firstName: 'Camila',
      lastName: 'Rodríguez',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'CloudMonitor — Monitoreo de infraestructura',
    },
    student: {
      id: 'default-student-4',
      firstName: 'Julián',
      lastName: 'Fernández',
